...
/* grupinfo table */
create table grupinfo(grupiden text primary key not null, grupname text not null, username text not null, foreign key(username) references userdata(username))
